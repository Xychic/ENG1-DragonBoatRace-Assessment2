...
import main.com.dragonboatrace.game.entities.Button;
...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen(DragonBoatRace game) {
        ...
        for (int i = 0; i < 3; i++) {
            this.saveGameSlot[i] = new File(
                    String.format("%s/dragonBoatSave-%d.json", Config.SAVE_FILE_LOCATION, i + 1)).exists();
        ...
        this.helpButton = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 450f / Config.SCALAR),
                "help_button_active.png", "help_button_inactive.png");
        this.loadButton = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 300f / Config.SCALAR),
                this.saveGame ? "load_button_active.png" : "load_button_disabled.png",
                this.saveGame ? "load_button_inactive.png" : "load_button_disabled.png");
        this.exitButton = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 150f / Config.SCALAR),
                "exit_button_active.png", "exit_button_inactive.png");

        this.slot1Button = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 600f / Config.SCALAR),
                this.saveGameSlot[0] ? "slot1_button_active.png" : "slot1_button_disabled.png",
                this.saveGameSlot[0] ? "slot1_button_inactive.png" : "slot1_button_disabled.png");
        this.slot2Button = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 450f / Config.SCALAR),
                this.saveGameSlot[1] ? "slot2_button_active.png" : "slot2_button_disabled.png",
                this.saveGameSlot[1] ? "slot2_button_inactive.png" : "slot2_button_disabled.png");
        this.slot3Button = new Button(
                new Vector2((Gdx.graphics.getWidth() - EntityType.BUTTON.getWidth()) / 2.0f, 300f / Config.SCALAR),
                this.saveGameSlot[2] ? "slot3_button_active.png" : "slot3_button_disabled.png",
                this.saveGameSlot[2] ? "slot3_button_inactive.png" : "slot3_button_disabled.png");
    ...
    public void render(float delta) {
        ...
        this.game.getBatch()
                .draw(logo, (Gdx.graphics.getWidth() - logoXOffset) / 2.0f, (Gdx.graphics.getHeight() - logoYOffset
                        + playButton.getHitBox().getHeight() + playButton.getHitBox().getY()) / 2.0f, logoXOffset,
                        logoYOffset);
    ...
    private void loadGame(int save) {
        FileHandle saveFile = new FileHandle(
                new File(String.format("%s/dragonBoatSave-%d.json", Config.SAVE_FILE_LOCATION, save)));
