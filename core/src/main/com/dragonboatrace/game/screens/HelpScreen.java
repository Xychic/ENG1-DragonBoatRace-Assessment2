...
public class HelpScreen implements Screen {
    ...
    public HelpScreen(MainMenuScreen callBack) {
        ...
        this.maxHeight = Gdx.graphics.getHeight() - this.helpInfo.getHeight() / Config.SCALAR;

        this.currPos = maxHeight;
        this.padding = 200 / Config.SCALAR;
        ...
        parameter.size *= 3.0 / Config.SCALAR;
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(this.helpInfo, padding, currPos, Gdx.graphics.getWidth() - 2 * padding, (float) this.helpInfo.getHeight() / Config.SCALAR);
        if(currPos==this.maxHeight){
            font.draw(batch,"Scroll Down",(Gdx.graphics.getWidth() - layout.width) / 2, layout.height + 120f/Config.SCALAR);
            batch.draw(this.downArrow, Gdx.graphics.getWidth() / 2f - 50f/Config.SCALAR, 0, 100f/Config.SCALAR, 100f/Config.SCALAR);
        }
